    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6">
            <div class="card" id="vvvv">
                <div class="card-header">
                    <h3 class="card-title">配置权限(@{{checkedPermissions.length}})</h3>
                    <small></small>
                </div>
                <div class="card-body">
                ...
                <div class="card-footer">
                    <a href="javascript:" class="btn btn-primary" v-on:click="save" v-bind:disabled="!changed">保存</a>
                </div>
            </div>
        </div>
    </div>
